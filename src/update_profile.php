			...
			<div class="bg-white shadow rounded-lg d-block d-sm-flex">
				<div class="profile-tab-nav border-right">
					...
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active" id="account-tab" id="security-tab" data-toggle="pill" href="#account"
						...
						<a class="nav-link" id="rfid-tab" data-toggle="pill" href="#rfid_tab" role="tab"
							aria-controls="rfid-tab" aria-selected="false">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input id="firstname-input" type="text" class="form-control" name="first_name"
										required="required" placeholder="First Name" autocomplete="off"
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input id="lastname-input" type="text" class="form-control" name="last_name"
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Gender</label>
									<select id="gender-input" class="form-control" name="gender"
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="number" name="contact_number" class="form-control" id="number-input"
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="rfid_input" id="rfid_input"
										value="<?php echo $row["rfid_no"]; ?>">
