  ...
  if ($result->num_rows == 1) {
    ...
    if (password_verify($password, $stored_password)) {
      ...
      if ($result2->num_rows == 1) {
        ...
        $_SESSION["picture"] = $user_row['picture'];
      ...
      <div class="inner-box">
        <div class="forms-wrap">
          ...
          <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" autocomplete="on"
            class="sign-in-form needs-validation" novalidate>
            <div class="logo">
            ...
            <div class="actual-form">
              ...
              <div class="form-floating mb-3">
                <input type="password" name="login_password" class="form-control" id="login_password" autocomplete="off"
                  required>
          ...
          <form id="register-form" autocomplete="off" class="sign-up-form needs-validation">
            ...
            <div class="actual-form">
              <div class="row mb-3">
                <div class="col">
                  <div class="form-floating">
                    <input type="text" name="firstName" minlength="4" class="form-control" id="firstName"
              ...
              <div class="row mb-3">
                <div class="col">
                  <button type="submit" style="background-color: #a81c1c;" class="btn text-white sign-btn"
