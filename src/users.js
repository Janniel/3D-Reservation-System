...
setupTableSorting('users_table');

// Call the function again to set up sorting for the "Archived" table
setupTableSorting('archivedUsers_table');
...
const archived_users_table = document.querySelector('#archivedUsers_table');
