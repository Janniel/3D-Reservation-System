                                    ...
                                    <section class="table__header">
                                            ...
                                            <form action="brw_history.php" method="GET">
                                                <div class="row">
                                                    <div class="floor" class="form-control">
                                                        ...
                                                        <select class="form-control" name="user-type-filter" id="user-type-filter">
                                                    ...
                                                    <div class="college">
                                                        ...
                                                        <select class="form-control" name="college-filter" id="college-filter">
                                                    ...
                                                    <div class="course">
                                                        ...
                                                        <select class="form-control" name="course-filter" id="course-filter">
                                                            <option value="" selected>All</option>
                                                            <?php
                                                            // Replace with your database connection code
                                                            require 'connect.php';
                                                    ...
                                                    <div class="col-md-2">
                                                        <button type="button" id="clear-filter-all" class="buttons">Clear</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <section class="table__body">
                                            <table id="users_table">
                                                <thead>
                                                    <tr>
                                                        <th id="all-users-id"> User ID <span class="icon-arrow">&UpArrow;</span></th>
                                        ...
                                        <section class="table__header">
                                            ...
                                            <form action="brw_history.php" method="GET">
                                                <div class="row">
                                                    <div class="floor" class="form-control">
                                                        <label for="cars">User Type</label>
                                                        <select class="form-control" name="user-type-archived-filter" id="archive-user-type-archived-filter">
                                                            <option value="All" selected>All</option>
                                                            <option value="student">student</option>
                                                            <option value="faculty">faculty</option>
                                                            <option value="alumni">alumni</option>
                                                    ...
                                                    <div class="college">
                                                        ...
                                                        <select class="form-control" name="college-archived-filter" id="archive-college-archived-filter">
                                                            <option value="" selected>All</option>
                                                            <?php
                                                            // Replace with your database connection code
                                                            require 'connect.php';
                                                    ...
                                                    <div class="course">
                                                        <label for ="course-filter">Course</label>
                                                        <select class="form-control" name="course-archived-filter" id="archive-course-archived-filter">
                                                            <option value="" selected>All</option>
                                                            <?php
                                                            // Replace with your database connection code
                                                            require 'connect.php';
                                                    ...
                                                    <div class="col-md-2">
                                                        <button type="button" id="clear-filter-archived" class="buttons">Clear</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                                        ...
                                                        while ($row = $archiveResult->fetch_assoc()) {
                                                            ...
                                                            <tr id="archivedUser_row_<?php echo $row['user_id']; ?>">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-light btn-rounded btn-icon restore_btn"
                                                                        data-user-id="<?php echo $row['user_id']; ?>"
                                                                        onclick="restoreUser(<?php echo $row['user_id']; ?>)">
                                                                        <i class="bi bi-arrow-counterclockwise text-warning" style="font-size: 1.2em;"></i>
                                                                    </button>
                                                                    <button type="button"
